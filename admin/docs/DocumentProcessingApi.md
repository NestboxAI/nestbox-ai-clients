...
|[**documentProcessingControllerDeleteProfile**](#documentprocessingcontrollerdeleteprofile) | **DELETE** /projects/{projectId}/document-processing/{instanceId}/profiles/{profileId} | Soft-delete (archive) a processing profile|
...
# **documentProcessingControllerDeleteProfile**
> object documentProcessingControllerDeleteProfile()
...
const { status, data } = await apiInstance.documentProcessingControllerDeleteProfile(
    projectId,
    instanceId,
    profileId
);
